...
async function parseXmlString(data, timeoutMs = 2000) {
    ...
    const xmlDoc = node_vm_1.default.runInContext('libxml2.XmlDocument.fromString(data, { option })', sandbox, { timeout: timeoutMs });
