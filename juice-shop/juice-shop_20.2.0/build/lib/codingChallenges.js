...
exports.BrokenBoundary = exports.findFilesWithCodeChallenges = exports.SNIPPET_PATHS = void 0;
exports.getCodingChallengeFromFileContent = getCodingChallengeFromFileContent;
exports.getCodeChallenges = getCodeChallenges;
const promises_1 = __importDefault(require("node:fs/promises"));
const node_path_1 = __importDefault(require("node:path"));
const logger_1 = __importDefault(require("./logger"));
exports.SNIPPET_PATHS = Object.freeze(['./server.ts', './routes', './lib', './data', './data/static/web3-snippets', './frontend/src/app', './models', './infrastructure']);
...
exports.BrokenBoundary = BrokenBoundary;
