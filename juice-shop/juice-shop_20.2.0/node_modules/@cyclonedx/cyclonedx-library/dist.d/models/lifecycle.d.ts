...
export declare class NamedLifecycle implements Comparable<NamedLifecycle> {
    name: string;
    description?: string;
...
export declare class LifecycleRepository extends Set<Lifecycle> implements Sortable<Lifecycle> {
    #private;
    sorted(): Lifecycle[];
}
