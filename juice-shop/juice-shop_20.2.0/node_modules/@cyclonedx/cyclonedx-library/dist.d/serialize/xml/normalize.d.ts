...
export declare class ToolsNormalizer extends BaseXmlNormalizer<Models.Tools> {
...
export declare class ServiceNormalizer extends BaseXmlNormalizer<Models.Service> {
